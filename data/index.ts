...
export const gridItems = [
  ...
  {
    id: 6,
    title: "Do you want to get connected?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const projects = [
  {
    id: 1,
    title: "Ecommerce Website using FAKEStore API",
    des: "Created a small ecommerce website using FakeStore API.",
    img: "/fakeStore.png",
    iconLists: [
      "/re.svg",
      "/tail.svg",
    ...
    link: "https://fakestore-wajiha.netlify.app/",
  },
  {
    id: 2,
    ...
    link: "https://pet-social-media-client.vercel.app/",
  },
  {
    id: 3,

...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-4 mx-auto",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "wajihatahir1994@gmail.com";
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className={`font-sans text-lg lg:text-2xl max-w-96 z-10`}>
            {title}
          </div>
